...
export const practices: ReadonlyArray<Practice> = [
  ...
  },
  {
    ...
    coverImage: '/images/female/gym-warmup-march.webp',
    accent: 'sage',
    steps: [
      { id: 'gym-warmup-march', title: 'Ходьба на месте с махами рук', instruction: 'Шагайте на месте в спокойном темпе и свободно чередуйте махи руками. Держите корпус высоким, приземляйтесь мягко на всю стопу.', durationSeconds: 60 },
      { id: 'gym-warmup-neck-turns', title: 'Повороты головы', instruction: 'Плавно поверните голову вправо и влево, оставляя плечи на одном уровне. Работайте в комфортной амплитуде, без рывков и давления.', durationSeconds: 60 },
      { id: 'gym-warmup-shoulder-shrugs', title: 'Подъёмы и опускания плеч', instruction: 'На вдохе мягко поднимайте плечи к ушам, на выдохе опускайте их вниз. Шея остаётся длинной, а движения - спокойными.', durationSeconds: 60 },
      { id: 'gym-warmup-shoulder-circles', title: 'Круги плечами', instruction: 'Выполняйте широкие круги плечами назад, затем плавно продолжайте движение. Не запрокидывайте голову и не ускоряйтесь.', durationSeconds: 60 },
      { id: 'gym-warmup-arm-swings', title: 'Маятник руками', instruction: 'Раскрывайте руки в стороны и мягко скрещивайте их перед грудью, каждый раз меняя верхнюю руку. Корпус остаётся устойчивым.', durationSeconds: 60 },
      { id: 'gym-warmup-chest-open', title: 'Раскрытие груди', instruction: 'Уводите прямые руки немного назад и возвращайте их вперёд без резкого прогиба в пояснице. Почувствуйте движение в плечах и грудной клетке.', durationSeconds: 60 },
      { id: 'gym-warmup-arm-circles', title: 'Круги прямыми руками', instruction: 'Делайте небольшие круги прямыми руками, затем постепенно увеличивайте их амплитуду. Через 30 секунд смените направление.', durationSeconds: 60 },
      { id: 'gym-warmup-torso-turns', title: 'Повороты корпуса', instruction: 'Поворачивайте грудную клетку вправо и влево, сохраняя стопы направленными вперёд. Руки двигаются свободно вместе с корпусом.', durationSeconds: 60 },
      { id: 'gym-warmup-hip-hinge-reach', title: 'Наклон с вытяжением рук', instruction: 'Отведите таз назад, слегка согните колени и вытяните руки вперёд. Сохраняйте длинную спину и вернитесь в стойку без рывка.', durationSeconds: 60 },
      { id: 'gym-warmup-hip-circles', title: 'Круги тазом', instruction: 'Положите ладони на таз и рисуйте им плавные круги. Двигайтесь в небольшом контролируемом диапазоне, затем смените направление.', durationSeconds: 60 },
      { id: 'gym-warmup-hip-openers', title: 'Раскрытие бедра стоя', instruction: 'Поднимите согнутое колено и мягко откройте его в сторону, затем верните в центр. Через 30 секунд смените опорную ногу.', durationSeconds: 60 },
      { id: 'gym-warmup-leg-swings', title: 'Махи ногой вперёд и назад', instruction: 'Слегка придерживайтесь за устойчивую опору и выполняйте свободные махи прямой ногой вперёд и назад. Через 30 секунд поменяйте ногу.', durationSeconds: 60 },
      { id: 'gym-warmup-side-lunge-warmup', title: 'Боковые выпады', instruction: 'Сделайте шаг в сторону, отведите таз назад и мягко согните опорную ногу. Вернитесь в центр и чередуйте стороны в спокойном темпе.', durationSeconds: 60 },
      { id: 'gym-warmup-reverse-lunge-reach', title: 'Обратные выпады с подъёмом рук', instruction: 'Сделайте небольшой шаг назад и поднимите руки вверх, сохраняя устойчивый корпус. Вернитесь в исходное положение и чередуйте ноги.', durationSeconds: 60 },
      { id: 'gym-warmup-squat-calf-raise', title: 'Приседание с подъёмом на носки', instruction: 'Выполните неглубокое приседание, выпрямитесь и плавно поднимитесь на носки. Колени направлены по линии стоп, движение остаётся контролируемым.', durationSeconds: 60 },
    ],
  },
  {
    id: 'band-shoulders',
